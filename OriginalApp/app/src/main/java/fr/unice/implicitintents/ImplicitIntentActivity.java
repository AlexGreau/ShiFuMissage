...
public class ImplicitIntentActivity extends AppCompatActivity {
        ...
        browseButton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent geoIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://" + address));
    ...
    private void smsButtonClicked() {
        if ((ContextCompat.checkSelfPermission(ImplicitIntentActivity.this, SEND_SMS) != PERMISSION_GRANTED) ||
                (ContextCompat.checkSelfPermission(ImplicitIntentActivity.this, READ_CONTACTS) != PERMISSION_GRANTED)) {
